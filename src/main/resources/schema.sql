...
-- Table `kanban`.`teamId`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kanban`.`teamId` (
...
-- Table `kanban`.`userId`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kanban`.`userId` (
  `id`       INT(11)      NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE INDEX `username` USING BTREE (`username` ASC)
)
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8
  ROW_FORMAT = DYNAMIC;
...
#   `obj_id` INT(11) NOT NULL,
#   `time` TIME NOT NULL,
#   PRIMARY KEY (`activity_project_id`, `activity_user_id`),
#   INDEX `activity_user` (`activity_user_id` ASC),
#   CONSTRAINT `activity_project`
...
# -- -----------------------------------------------------
# CREATE TABLE IF NOT EXISTS `kanban`.`attachment` (
#   `attachment_card_id` INT(11) NOT NULL,
#   `attachment_user_id` INT(11) NOT NULL,
#   `file_name` VARCHAR(128) NOT NULL,
#   `path` VARCHAR(128) NOT NULL,
#   `time` TIME NOT NULL,
#   PRIMARY KEY (`attachment_card_id`, `attachment_user_id`),
#   INDEX `attachment_user` (`attachment_user_id` ASC),
#   CONSTRAINT `attachment_card`
#   FOREIGN KEY (`attachment_card_id`)
#   REFERENCES `kanban`.`card` (`id`),
#   CONSTRAINT `attachment_user`
#   FOREIGN KEY (`attachment_user_id`)
#   REFERENCES `kanban`.`userId` (`id`))
#   ENGINE = InnoDB
#   DEFAULT CHARACTER SET = utf8;
#
...
# -- -----------------------------------------------------
# CREATE TABLE IF NOT EXISTS `kanban`.`card_assignment` (
#   `card_assignment_card_id` INT(11) NOT NULL,
#   `card_assignment_user_id` INT(11) NOT NULL,
#   PRIMARY KEY (`card_assignment_card_id`, `card_assignment_user_id`),
#   INDEX `card_assignment_user` (`card_assignment_user_id` ASC),
#   CONSTRAINT `card_assignment_card`
#   FOREIGN KEY (`card_assignment_card_id`)
#   REFERENCES `kanban`.`card` (`id`),
#   CONSTRAINT `card_assignment_user`
#   FOREIGN KEY (`card_assignment_user_id`)
#   REFERENCES `kanban`.`userId` (`id`))
#   ENGINE = InnoDB
#   DEFAULT CHARACTER SET = utf8;
#
...
# -- -----------------------------------------------------
# CREATE TABLE IF NOT EXISTS `kanban`.`card_subscription` (
#   `card_subscription_card_id` INT(11) NOT NULL,
#   `card_subscription_user_id` INT(11) NOT NULL,
#   PRIMARY KEY (`card_subscription_card_id`, `card_subscription_user_id`),
#   INDEX `card_subscription_user` (`card_subscription_user_id` ASC),
#   CONSTRAINT `card_subscription_card`
#   FOREIGN KEY (`card_subscription_card_id`)
#   REFERENCES `kanban`.`card` (`id`),
#   CONSTRAINT `card_subscription_user`
#   FOREIGN KEY (`card_subscription_user_id`)
#   REFERENCES `kanban`.`userId` (`id`))
#   ENGINE = InnoDB
#   DEFAULT CHARACTER SET = utf8;
#
...
#   `id` INT(11) NOT NULL,
#   `name` VARCHAR(128) NOT NULL,
#   `checklist_card_id` INT(11) NOT NULL,
#   PRIMARY KEY (`id`),
#   INDEX `IX_Relationship31` (`checklist_card_id` ASC),
#   CONSTRAINT `card_checcklist`
#   FOREIGN KEY (`checklist_card_id`)
#   REFERENCES `kanban`.`card` (`id`)
#     ON DELETE CASCADE
#     ON UPDATE CASCADE)
#   ENGINE = InnoDB
...
# -- -----------------------------------------------------
# CREATE TABLE IF NOT EXISTS `kanban`.`comment` (
#   `comment_card_id` INT(11) NOT NULL,
#   `comment_user_id` INT(11) NOT NULL,
#   `content` MEDIUMTEXT NOT NULL,
#   `time` TIME NOT NULL,
#   PRIMARY KEY (`comment_card_id`, `comment_user_id`),
#   INDEX `comment_user` (`comment_user_id` ASC),
#   CONSTRAINT `comment_card`
#   FOREIGN KEY (`comment_card_id`)
#   REFERENCES `kanban`.`card` (`id`),
#   CONSTRAINT `comment_user`
...
# -- -----------------------------------------------------
# CREATE TABLE IF NOT EXISTS `kanban`.`label_card` (
#   `label_card_label_id` INT(11) NOT NULL,
#   `label_card_card_id` INT(11) NOT NULL,
#   PRIMARY KEY (`label_card_label_id`, `label_card_card_id`),
#   INDEX `label_card_card` (`label_card_card_id` ASC),
#   CONSTRAINT `label_card_card`
#   FOREIGN KEY (`label_card_card_id`)
#   REFERENCES `kanban`.`card` (`id`),
#   CONSTRAINT `label_card_label`
#   FOREIGN KEY (`label_card_label_id`)
#   REFERENCES `kanban`.`label` (`id`))
#   ENGINE = InnoDB
#   DEFAULT CHARACTER SET = utf8;
#
...
# -- -----------------------------------------------------
# CREATE TABLE IF NOT EXISTS `kanban`.`project_member` (
#   `project_member_project_id` INT(11) NOT NULL,
#   `project_member_user_id` INT(11) NOT NULL,
#   `isAdmin` TINYINT(1) NOT NULL,
#   PRIMARY KEY (`project_member_project_id`, `project_member_user_id`),
#   INDEX `project_member_user` (`project_member_user_id` ASC),
#   CONSTRAINT `project_member_project`
#   FOREIGN KEY (`project_member_project_id`)
#   REFERENCES `kanban`.`project` (`id`),
#   CONSTRAINT `project_member_user`
#   FOREIGN KEY (`project_member_user_id`)
#   REFERENCES `kanban`.`userId` (`id`))
#   ENGINE = InnoDB
#   DEFAULT CHARACTER SET = utf8;
#
